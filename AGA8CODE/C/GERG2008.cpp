...
int main()
{
    ...
    printf("Molar density [mol/l]:              12.79828626082062 != %0.16g\n",D);
    printf("Pressure [kPa]:                     50000.00000000001 != %0.16g\n",P);
    printf("Compressibility factor:             1.174690666383717 != %0.16g\n",Z);
    printf("d(P)/d(rho) [kPa/(mol/l)]:          7000.694030193327 != %0.16g\n",dPdD);
    printf("d^2(P)/d(rho)^2 [kPa/(mol/l)^2]:    1130.481239114938 != %0.16g\n",dPdD2);
    printf("d(P)/d(T) [kPa/K]:                  235.9832292593096 != %0.16g\n",dPdT);
    printf("Energy [J/mol]:                     -2746.492901212530 != %0.16g\n",U);
    printf("Enthalpy [J/mol]:                   1160.280160510973 != %0.16g\n",H);
    printf("Entropy [J/mol-K]:                  -38.57590392409089 != %0.16g\n",S);
    printf("Isochoric heat capacity [J/mol-K]:  39.02948218156372 != %0.16g\n",Cv);
    printf("Isobaric heat capacity [J/mol-K]:   58.45522051000366 != %0.16g\n",Cp);
    printf("Speed of sound [m/s]:               714.4248840596024 != %0.16g\n",W);
